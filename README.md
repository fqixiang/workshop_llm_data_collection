...
| 12:45 | Inference with LLM-collected data    | [`python`](https://colab.research.google.com/github/sodascience/workshop_llm_data_collection/blob/main/notebooks/llm_regression_modelling_py.ipynb), [`R`](./notebooks/llm_inference_R.ipynb)     |
